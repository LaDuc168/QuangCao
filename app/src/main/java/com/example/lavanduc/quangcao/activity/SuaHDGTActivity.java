...
public class SuaHDGTActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sua_hdgt);
        init();
        String kq=  getIntent().getStringExtra("MA");
        gt=getGT(kq);
    ...
    private HoatDongGT getGT(String ma) {
        ...
        for (int i = 0; i < cursor.getCount(); i++) {
            ...
            HoatDongGT hd = new HoatDongGT(ma, thoigianbd,thoigiankt,mota,binhluan,luotthich,diadiem, anh, ten);
    ...
    private void setValue() {
        edtma.setText(gt.getMa());
        edtten.setText(gt.getTen());
        edtthoigianbd.setText(gt.getThoigianbd());
        edtthoigiankt.setText(gt.getThoigiankt());
        edtmota.setText(gt.getMotachitiet());
        edtbinhluan.setText(gt.getBinhluan());
        edtdiadiem.setText(gt.getDiadiem());
        Bitmap bitmap= BitmapFactory.decodeByteArray(gt.getAnh(),0,gt.getAnh().length);
    ...
    private void addEvent() {
        ...
        btnThem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                HoatDongGT hd = new HoatDongGT(ma, thoigianbd, thoigiankt, mota, binhluan, gt.getLuotthich(), diadiem, anh, ten);
                long check = ThemHDGT(hd);
                if (check > 0) {
                    Toast.makeText(SuaHDGTActivity.this, "Sửa thành công", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(SuaHDGTActivity.this, "Sửa thất bại", Toast.LENGTH_SHORT).show();
                }
                startActivity(new Intent(SuaHDGTActivity.this, HoatDongGTActivity.class));
                finish();
            }
        });
        ...
        imgChup.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ActivityCompat.requestPermissions(SuaHDGTActivity.this,
    ...
    private long ThemHDGT(HoatDongGT hd) {
        ...
        contentValues.put("thoigianbd", hd.getThoigianbd());
        contentValues.put("thoigiankt", hd.getThoigiankt());
        ...
        return sqLiteDatabase.update("HoatDongGT", contentValues, "ma=?", new String[]{
                hd.getMa()
        });
    }
